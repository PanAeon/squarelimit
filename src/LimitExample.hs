module LimitExample where

import Prelude hiding (cycle)
import Diagrams.Prelude
import Diagrams.Backend.SVG.CmdLine -- ! hmm

-- * from diagrams example package 
someFunc :: IO ()
...
data Picture
  ...
  | SkewQuartet Picture Picture Picture Picture
...
--- marking defines fish with nearby fish ...
markingsP = [
   [ (4^&4), (6^&0) ],
   [ (0^&3), (3^&4), (0^&8), (0^&3) ],
   [ (4^&5), (7^&6), (4^&10), (4^&5) ],
